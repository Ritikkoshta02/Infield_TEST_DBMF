...
# DMFB specification
(numRows, numCols) = (6,8)
dropletDispenserDict = {1:(1,3), 2: (1,6), 3:(1,6), 4 : (1,3), 5:(1,3), 6:(1,3)} #Id: dispense locations (x,y)
Map = {(1, 3, 1) : 1, (1, 6, 1) : 2, (1, 6, 12) : 3, (1, 3, 14) : 4, (1, 3, 29) : 5, (1, 3, 37) : 6} #dispance location (x, y, t) : Id
outputLocationList = [(3,8)]
...
def main():
    ...
    DisappearenceDic[(3,8)].append(13)
    
    DispanceDic = defaultdict(list)
    DispanceDic[(1,3)].append(1)
    DispanceDic[(1,6)].append(1)
    DispanceDic[(1,6)].append(12)
    DispanceDic[(1,3)].append(14)
    DispanceDic[(1,3)].append(29)
    DispanceDic[(1,3)].append(37)
    ...
    enforceMixing(clauseFile, (2,3), (2,6), 3, 6, dropletIdList)
    enforceMixing(clauseFile, (4,3), (4,6), 16, 6, dropletIdList)
    enforceMixing(clauseFile, (6,3), (6,6), 29, 6, dropletIdList)
    enforceMixing(clauseFile, (4,3), (4,6), 38, 6, dropletIdList)
    enforceMixing(clauseFile, (2,3), (2,6), 47, 12, dropletIdList)
