...
# DMFB specification
(numRows, numCols) = (8,8)
dropletDispenserDict = {1 : (3, 1), 2 : (1, 6), 3 : (1, 6), 4 : (1, 6)} #Id: dispense locations (x,y)
Map = {(3, 1, 1) : 1, (1, 6, 1) : 2, (1, 6, 18) : 3, (1, 6, 29) : 4} #Id: dispance location (x, y, t)
outputLocationList = [(3, 8), (6, 8), (8, 3)]
...
def main():
    ...
    DisappearenceDic[(3, 8)].append(65)
    DisappearenceDic[(6, 8)].append(86)
    DisappearenceDic[(6, 8)].append(103)
    DisappearenceDic[(8, 3)].append(106)
    
    DispanceDic = defaultdict(list)
    DispanceDic[(3,1)].append(1)
    DispanceDic[(1, 6)].append(1)
    DispanceDic[(1, 6)].append(18)
    DispanceDic[(1, 6)].append(29)
    ...
    enforceMixing(clauseFile, (3,3), (3,6), 23, 12, dropletIdList)
    enforceMixing(clauseFile, (3,3), (3,6), 41, 18, dropletIdList)
    enforceMixing(clauseFile, (6,3), (6,6), 64, 6, dropletIdList)
    enforceMixing(clauseFile, (6,3), (6,6), 81, 12, dropletIdList)
    #proximityAttack_at_t(clauseFile, dropletIdList, 1)
    proximityAttack(clauseFile, dropletIdList)
    insertCheckpoint1X(clauseFile, (1, 6), 1, dropletIdList)
    insertCheckpoint1X(clauseFile, (3, 1), 1, dropletIdList)
    insertCheckpoint1X(clauseFile, (3, 3), 4, dropletIdList)
    ...
    insertCheckpoint1X(clauseFile, (3, 6), 6, dropletIdList)
    insertCheckpoint1X(clauseFile, (1, 6), 18, dropletIdList)
    ...
    insertCheckpoint1X(clauseFile, (6, 3), 64, dropletIdList)
    insertCheckpoint1X(clauseFile, (6, 6), 64, dropletIdList)
    insertCheckpoint1X(clauseFile, (8, 6), 64, dropletIdList)
    insertCheckpoint1X(clauseFile, (6, 3), 85, dropletIdList)
    insertCheckpoint1X(clauseFile, (6, 6), 85, dropletIdList)
    insertCheckpoint1X(clauseFile, (6, 8), 85, dropletIdList)
    insertCheckpoint1X(clauseFile, (6, 8), 102, dropletIdList)
    insertCheckpoint1X(clauseFile, (8, 3), 102, dropletIdList)
    insertCheckpoint1X(clauseFile, (8, 3), 105, dropletIdList)
