...
def main():
    ...
    DisappearenceDic[(1,3)].append(24)
    DisappearenceDic[(8,3)].append(24)
    DisappearenceDic[(3,8)].append(33)
    DisappearenceDic[(6,8)].append(33)
    
    DispanceDic = defaultdict(list)
    DispanceDic[(3,1)].append(1)
    DispanceDic[(1,6)].append(1)
    DispanceDic[(8,6)].append(1)
    DispanceDic[(6,1)].append(1)
    ...
    enforceMixing(clauseFile, (3,3), (3,6), 4, 12, dropletIdList)
    enforceMixing(clauseFile, (6,3), (6,6), 4, 12, dropletIdList)
    enforceMixing(clauseFile, (3,6), (6,6), 17, 12, dropletIdList)
    #proximityAttack_at_t(clauseFile, dropletIdList, 1)
    proximityAttack(clauseFile, dropletIdList)
    insertCheckpoint1X(clauseFile, (3, 3), 16, dropletIdList)
    insertCheckpoint1X(clauseFile, (3, 6), 16, dropletIdList)
    insertCheckpoint1X(clauseFile, (6, 3), 16, dropletIdList)
    insertCheckpoint1X(clauseFile, (6, 6), 16, dropletIdList)
    insertCheckpoint1X(clauseFile, (3, 3), 17, dropletIdList)
    insertCheckpoint1X(clauseFile, (4, 6), 17, dropletIdList)
    insertCheckpoint1X(clauseFile, (5, 6), 17, dropletIdList)
    insertCheckpoint1X(clauseFile, (6, 3), 17, dropletIdList)
    insertCheckpoint1X(clauseFile, (3, 3), 18, dropletIdList)
    insertCheckpoint1X(clauseFile, (4, 6), 18, dropletIdList)
    insertCheckpoint1X(clauseFile, (6, 3), 18, dropletIdList)
    insertCheckpoint1X(clauseFile, (2, 3), 20, dropletIdList)
    insertCheckpoint1X(clauseFile, (4, 6), 20, dropletIdList)
    insertCheckpoint1X(clauseFile, (7, 3), 20, dropletIdList)
    insertCheckpoint1X(clauseFile, (1, 3), 23, dropletIdList)
    insertCheckpoint1X(clauseFile, (4, 6), 23, dropletIdList)
    insertCheckpoint1X(clauseFile, (5, 6), 23, dropletIdList)
    insertCheckpoint1X(clauseFile, (8, 3), 23, dropletIdList)
    insertCheckpoint1X(clauseFile, (3, 8), 31, dropletIdList)
    insertCheckpoint1X(clauseFile, (6, 8), 31, dropletIdList)
    insertCheckpoint1X(clauseFile, (3, 8), 32, dropletIdList)
    insertCheckpoint1X(clauseFile, (6, 8), 32, dropletIdList)
