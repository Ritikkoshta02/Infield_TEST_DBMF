...
def enforceDropletDisappearence(clauseFile, (x, y), t_list):
#===============================================================================
# A droplet can disappear on location (x,y) at each time t belongs to t_list
# This constraint does not guarantee droplet disappearance 
#=============================================================================== 
    global dropletDispenserDict
