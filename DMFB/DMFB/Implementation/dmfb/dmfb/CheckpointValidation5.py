...
# DMFB specification
(numRows, numCols) = (5,5)
dropletDispenserDict = {1:(2,5), 2: (4,5), 3: (4,5)} #Id: dispense locations (x,y)
outputLocationList = [(4,1)]
dropletIdList = [1, 2, 3]
...
def main():
    ...
    enforceDropletDispense(clauseFile, (2,5), [1])
    clauseFile.write("s.add(a_2_5_1_1)\n")
    #clauseFile.write("s.add(a_2_1_3_8)\n")
    #clauseFile.write("s.add(a_1_1_3_9)\n")
    
    enforceDropletDispense(clauseFile, (4,5), [1,8])
    clauseFile.write("s.add(a_4_5_2_1)\n")
    clauseFile.write("s.add(a_4_5_3_8)\n")
    
    #enforceMixing(clauseFile, (3,2), (3,5), 3, 4, dropletIdList)
    #enforceMixing(clauseFile, (3,2), (3,5), 12, 4, dropletIdList)
    
    enforceDropletDisappearence(clauseFile, (4,1), [11, 18, 19], dropletIdList)
    insertCheckpoint1X(clauseFile, (4,3), 3, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,3), 3, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,3), 4, dropletIdList)
    insertCheckpoint1X(clauseFile, (3,3), 4, dropletIdList)
    #insertCheckpoint1X(clauseFile, (2,3), 5, dropletIdList)
    #insertCheckpoint1X(clauseFile, (3,3), 5, dropletIdList)
    insertCheckpoint1X(clauseFile, (3,2), 5, dropletIdList)
    insertCheckpoint1X(clauseFile, (3,3), 5, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,2), 6, dropletIdList)
    insertCheckpoint1X(clauseFile, (3,2), 6, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,3), 7, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,2), 7, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,1), 8, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,4), 8, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,4), 9, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,1), 15, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,2), 15, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,1), 16, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,4), 10, dropletIdList)
    insertCheckpoint1X(clauseFile, (4,3), 10, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,3), 11, dropletIdList)
    insertCheckpoint1X(clauseFile, (3,3), 11, dropletIdList)
    insertCheckpoint1X(clauseFile, (3,2), 12, dropletIdList)
    insertCheckpoint1X(clauseFile, (3,3), 12, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,2), 13, dropletIdList)
    insertCheckpoint1X(clauseFile, (3,2), 13, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,2), 14, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,3), 14, dropletIdList)
    insertCheckpoint1X(clauseFile, (3,1), 17, dropletIdList)
    insertCheckpoint1X(clauseFile, (4,1), 10, dropletIdList)
    insertCheckpoint1X(clauseFile, (4,1), 17, dropletIdList)
    insertCheckpoint1X(clauseFile, (4,1), 18, dropletIdList)
    
    #enforceDropletDisappearence(clauseFile, (6,5), [20], dropletIdList)
    #insertCheckpoint1X(clauseFile, (6,5), 19, dropletIdList)
    constraint = "s.add(Or(Not(a_4_5_2_1), Not(a_2_5_1_1), Not(a_4_4_2_2), Not(a_2_4_1_2), Not(a_4_3_2_3), Not(a_2_3_1_3), Not(a_3_3_2_4), Not(a_2_3_1_4), "
    constraint += "Not(a_3_2_2_5), Not(a_3_3_1_5), Not(a_2_2_2_6), Not(a_3_2_1_6), Not(a_2_3_2_7), Not(a_2_2_1_7), Not(a_2_4_2_8), Not(a_2_1_1_8), "
    constraint += "Not(a_2_4_2_9), Not(a_3_1_1_9), Not(a_2_4_2_10), Not(a_4_1_1_10), Not(a_2_3_2_11), Not(a_4_5_3_8), Not(a_4_4_3_9), Not(a_4_3_3_10), "
    constraint += "Not(a_3_3_3_11), Not(a_3_3_2_12), Not(a_3_2_3_12), Not(a_3_2_2_13), Not(a_2_2_3_13), Not(a_2_2_2_14), Not(a_2_3_3_14), "
    constraint += "Not(a_2_1_2_15), Not(a_2_2_3_15), Not(a_3_1_2_16), Not(a_2_1_3_16), Not(a_4_1_2_17), Not(a_3_1_3_17), Not(a_4_1_3_18)))\n"
    clauseFile.write(constraint) 
