...
def main():
    ...
    enforceDropletDisappearence(clauseFile, (5,1), [15, 25], dropletIdList)
    insertCheckpoint1X(clauseFile, (5,1), 9, dropletIdList)
    insertCheckpoint1X(clauseFile, (5,1), 24, dropletIdList)
    insertCheckpoint1X(clauseFile, (3,2), 17, dropletIdList) 
    insertCheckpoint1X(clauseFile, (3,5), 17, dropletIdList)
    insertCheckpoint1X(clauseFile, (3,2), 19, dropletIdList)
    ...
    enforceDropletDisappearence(clauseFile, (6,5), [25], dropletIdList)
    insertCheckpoint1X(clauseFile, (6,5), 24, dropletIdList)    
    #clauseFile.write("s.add(Or(Not(a_5_1_1_9), Not(a_5_1_3_24), Not(a_6_5_2_24)))\n") 
    clauseFile.write("s.add(Or(Not(Or(a_3_5_3_12, a_3_2_3_12)), Not(Or(a_3_5_2_12, a_3_2_2_12))))\n") 
