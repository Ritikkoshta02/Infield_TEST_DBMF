...
def main():
    ...
    clauseFile.write("s.add(a_3_5_3_8)\n")
    clauseFile.write("s.add(a_3_5_4_16)\n")
    
    enforceDropletDispense(clauseFile, (3,5), [1,8,16])
    #clauseFile.write("s.add(a_2_6_2_1)\n")
    
    enforceMixing(clauseFile, (3,1), (3,4), 3, 4, dropletIdList)
    enforceMixing(clauseFile, (3,2), (3,5), 10, 4, dropletIdList)
    enforceMixing(clauseFile, (3,2), (3,5), 17, 4, dropletIdList)
    enforceMixing(clauseFile, (2,2), (2,5), 24, 4, dropletIdList)
    enforceMixing(clauseFile, (2,2), (2,5), 30, 4, dropletIdList)
    enforceDropletDisappearence(clauseFile, (1,3), [25, 30, 37], dropletIdList)
    insertCheckpoint1X(clauseFile, (5,1), 11, dropletIdList)
    insertCheckpoint1X(clauseFile, (4,3), 16, dropletIdList)
    insertCheckpoint1X(clauseFile, (5,1), 16, dropletIdList)
    enforceDropletDisappearence(clauseFile, (5,3), [39], dropletIdList)
    insertCheckpoint1X(clauseFile, (5,1), 20, dropletIdList)   
    
    #Output Swap attacks
    #clauseFile.write("s.add(Or(Not(a_1_3_3_24), Not(a_1_3_4_29), Not(a_1_3_2_36), Not(a_5_3_1_38)))\n")
    
    #MixSwap aattacks
    #clauseFile.write("s.add(Or(Not(Or(a_3_1_1_3, a_3_4_1_3)), Not(Or(a_3_1_2_3, a_3_4_2_3))))\n") 
    #clauseFile.write("s.add(Or(Not(Or(a_3_2_3_10, a_3_5_3_10)), Not(Or(a_3_2_2_10, a_3_5_2_10))))\n")
    #clauseFile.write("s.add(Or(Not(Or(a_3_2_3_17, a_3_5_3_17)), Not(Or(a_3_2_4_17, a_3_5_4_17))))\n")
    #clauseFile.write("s.add(Or(Not(Or(a_2_2_2_24, a_2_5_2_24)), Not(Or(a_2_2_3_24, a_2_2_3_24))))\n")
    #clauseFile.write("s.add(Or(Not(Or(a_2_2_2_30, a_2_5_2_30)), Not(Or(a_2_2_1_30, a_2_2_1_30))))\n")  
    #for t in range(0,T+1):
