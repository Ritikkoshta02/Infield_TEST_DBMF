...
# DMFB specification
(numRows, numCols) = (5,5)
dropletDispenserDict = {1:(2,1), 2: (1,3)} #Id: dispense locations (x,y)
outputLocationList = [(3,5), (5,4)]
...
def dropletMix(clauseFile, (x, y), d1, d2, (s, e)):
#===============================================================================
# A droplet is mixed in 2x2 at (x,y) as top left from s to e 
#===============================================================================
    constraint = "s.add(And("
    constraint += "a_%d_%d_%d_%d, "%(x,y,d1,s)
    constraint += "a_%d_%d_%d_%d, "%(x+1,y,d2,s)
    
    while s < e:
	constraint += "a_%d_%d_%d_%d, "%(x,y,d2,s+1)
        constraint += "a_%d_%d_%d_%d, "%(x,y+1,d1,s+1)
	constraint += "a_%d_%d_%d_%d, "%(x,y+1,d1,s+2)
        constraint += "a_%d_%d_%d_%d, "%(x+1,y+1,d1,s+2)
 	constraint += "a_%d_%d_%d_%d, "%(x+1,y+1,d2,s+3)
        constraint += "a_%d_%d_%d_%d, "%(x+1,y,d1,s+3)
	constraint += "a_%d_%d_%d_%d, "%(x+1,y,d2,s+4)
        constraint += "a_%d_%d_%d_%d, "%(x,y,d1,s+4)
	s+=4

    print (s)
    constraint += "a_%d_%d_%d_%d, "%(x-1,y,d1,s+1)
    constraint += "a_%d_%d_%d_%d, "%(x+2,y,d2,s+1)
    constraint = constraint[:-2] + "))\n"
    clauseFile.write(constraint)
...
def main():
    ...
    #dropletMix(clauseFile, (2, 2), 1, 2, (8, 12))
    #checkpoints
    clauseFile.write("s.add(Or(a_2_2_1_2, a_2_2_2_2))\n")
    clauseFile.write("s.add(Or(a_4_2_1_5, a_4_2_2_5))\n")
    clauseFile.write("s.add(Or(a_4_5_1_8, a_4_5_2_8))\n")
    clauseFile.write("s.add(Or(a_4_5_1_8, a_4_5_2_8))\n")
    clauseFile.write("s.add(Or(a_1_4_1_9, a_1_4_2_9))\n")
    clauseFile.write("s.add(Or(a_4_5_1_12, a_4_5_2_12))\n")

    clauseFile.write("s.add(Or(a_3_5_1_13, a_2_5_2_13))\n")
    clauseFile.write("s.add(Or(a_5_4_2_13, a_5_4_1_13))\n")
    #checking of unique result
    clauseFile.write("s.add(Or(Not(a_3_5_1_13), Not(a_5_4_2_13)))\n") 
