...
def main():
    ...
    insertCheckpoint0X(clauseFile, (8,8), 3, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,8), 8, dropletIdList)
    insertCheckpoint1X(clauseFile, (8,8), 9, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,8), 14, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,8), 16, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,8), 24, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,8), 29, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,8), 37, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,2), 3, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,2), 8, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,2), 9, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,2), 14, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,2), 16, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,2), 24, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,2), 29, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,2), 37, dropletIdList)
    insertCheckpoint0X(clauseFile, (6,7), 3, dropletIdList)
    insertCheckpoint0X(clauseFile, (6,7), 8, dropletIdList)
    insertCheckpoint0X(clauseFile, (6,7), 9, dropletIdList)
    insertCheckpoint0X(clauseFile, (6,7), 14, dropletIdList)
    insertCheckpoint0X(clauseFile, (6,7), 16, dropletIdList)
    insertCheckpoint0X(clauseFile, (6,7), 24, dropletIdList)
    
    insertCheckpoint0X(clauseFile, (6,7), 29, dropletIdList)
    insertCheckpoint0X(clauseFile, (6,7), 37, dropletIdList)
    insertCheckpoint0X(clauseFile, (1,3), 3, dropletIdList)
    insertCheckpoint0X(clauseFile, (1,3), 8, dropletIdList)
    insertCheckpoint0X(clauseFile, (1,3), 9, dropletIdList)
    insertCheckpoint0X(clauseFile, (1,3), 14, dropletIdList)
    insertCheckpoint0X(clauseFile, (1,3), 16, dropletIdList)
    insertCheckpoint0X(clauseFile, (1,3), 24, dropletIdList)
    insertCheckpoint1X(clauseFile, (1,3), 29, dropletIdList)
    insertCheckpoint1X(clauseFile, (1,3), 37, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,4), 3, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,4), 8, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,4), 9, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,4), 14, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,4), 16, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,4), 24, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,4), 29, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,4), 37, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,7), 3, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,7), 8, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,7), 9, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,7), 14, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,7), 16, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,7), 24, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,7), 29, dropletIdList)
    insertCheckpoint0X(clauseFile, (8,7), 37, dropletIdList)
    insertCheckpoint0X(clauseFile, (2,2), 3, dropletIdList)
    insertCheckpoint0X(clauseFile, (2,2), 8, dropletIdList)
    insertCheckpoint0X(clauseFile, (2,2), 9, dropletIdList)
    insertCheckpoint0X(clauseFile, (2,2), 14, dropletIdList)
    insertCheckpoint0X(clauseFile, (2,2), 16, dropletIdList)
    insertCheckpoint0X(clauseFile, (2,2), 24, dropletIdList)
    insertCheckpoint0X(clauseFile, (2,2), 29, dropletIdList)
    insertCheckpoint0X(clauseFile, (2,2), 37, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,7), 3, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,7), 8, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,7), 9, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,7), 14, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,7), 16, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,7), 24, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,7), 29, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,7), 37, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,6), 3, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,6), 8, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,6), 9, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,6), 14, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,6), 16, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,6), 24, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,6), 29, dropletIdList)
    insertCheckpoint0X(clauseFile, (4,6), 37, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,7), 3, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,7), 8, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,7), 9, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,7), 14, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,7), 16, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,7), 24, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,7), 29, dropletIdList)
    insertCheckpoint0X(clauseFile, (5,7), 37, dropletIdList)
