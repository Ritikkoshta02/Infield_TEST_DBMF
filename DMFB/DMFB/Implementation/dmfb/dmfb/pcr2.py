...
dropletDispenserDict = {2:(3,1), 1:(1,2), 3:(1,5), 20:(1,11), 6:(3,15), 5:(1,14), 4:(1,11), 13:(1,8), 3:(1,8), 13:(1,11), 11:(1,11), 12:(1,11), 9:(1,11)}  #Id: dispense locations (x,y)
...
def main():
    ...
    enforceDropletDisappearence(clauseFile, (7,1), [], dropletIdList)
