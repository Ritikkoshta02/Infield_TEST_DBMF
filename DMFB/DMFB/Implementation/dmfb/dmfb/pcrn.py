...
def main():
    ...
    enforceDropletDisappearence(clauseFile, (7,15), [22, 26, 54, 63], dropletIdList)
    ...
    insertCheckpoint1X(clauseFile, (5,12), 7, dropletIdList)
    insertCheckpoint1X(clauseFile, (5,12), 15, dropletIdList)
    #insertCheckpoint1X(clauseFile, (3,6), 19, dropletIdList)
    #insertCheckpoint1X(clauseFile, (5,2), 19, dropletIdList)
    #insertCheckpoint1X(clauseFile, (5,7), 19, dropletIdList)
    #insertCheckpoint1X(clauseFile, (5,10), 19, dropletIdList)
    #insertCheckpoint1X(clauseFile, (4,12), 19, dropletIdList)
    #insertCheckpoint1X(clauseFile, (5,14), 19, dropletIdList)
    #insertCheckpoint1X(clauseFile, (2,13), 19, dropletIdList)
    insertCheckpoint1X(clauseFile, (2,14), 21, dropletIdList)
    #insertCheckpoint1X(clauseFile, (2,12), 21, dropletIdList)
    #insertCheckpoint1X(clauseFile, (1,12), 22, dropletIdList)
