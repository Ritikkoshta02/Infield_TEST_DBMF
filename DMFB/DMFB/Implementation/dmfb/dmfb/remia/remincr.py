...
#===============================================================================
    ...
    clauseFile.write("import csv\n")
    clauseFile.write("import subprocess\n")
...
def finish(clauseFile):
    ...
    clauseFile.write("    fp.close()\n")
    clauseFile.write("    if(s.check()!= unsat):\n")
    clauseFile.write("        s.push()\n")
    clauseFile.write("        itr += 1\n")
    clauseFile.write("        print(\"trying new round\")\n")
    clauseFile.write("        subprocess.call([\"bash\",\"guide.sh\"])\n")
    clauseFile.write("        with open(\'list.txt\') as csvfile:\n")
    clauseFile.write("            readCSV = csv.reader(csvfile, delimiter=\',\')\n")
    clauseFile.write("            for row in readCSV:\n")
    clauseFile.write("                constraint = \"(\"\n")
    clauseFile.write("                for d in dropletIdList:\n")
    clauseFile.write("                    constraint += \"If(a_%d_%d_%d_%d == True, 1, 0) + \"%(int(row[0]),int(row[1]),d,int(row[2]))\n")
    clauseFile.write("                constraint = constraint[:-2] + \")== 1\"\n")
    clauseFile.write("                s.add(eval(constraint))\n")
    #clauseFile.write("                    insertCheckpoint1X(clauseFile, (int(row[0]),int(row[1])), int(row[2]), dropletIdList)\n")
    clauseFile.write("    else:\n")
    clauseFile.write("        print(\"number of trials: \",itr)\n")
    clauseFile.write("        print time.time()-start \n")
    clauseFile.write("        break\n")
...
def main():
    ...
    clauseFile.write("s.add(a_3_1_1_1)\n")
    ...
    #insertCheckpoint1X(clauseFile, (3,2), 7, dropletIdList) ##added script
    ...
    #insertCheckpoint1X(clauseFile, (3,2), 10, dropletIdList) ##added script
    ...
    #insertCheckpoint1X(clauseFile, (1,1), 13, dropletIdList) ##added script
    ...
    #insertCheckpoint1X(clauseFile, (1,1), 16, dropletIdList) ##added script
    ...
    #insertCheckpoint1X(clauseFile, (3,5), 19, dropletIdList) ##added script
    #insertCheckpoint1X(clauseFile, (1,1), 19, dropletIdList) ##added script
    #insertCheckpoint1X(clauseFile, (1,3), 20, dropletIdList) ##added script
    ...
    #insertCheckpoint1X(clauseFile, (3,3), 26, dropletIdList) ##added script
