...
def main():
    ...
    enforceMixing(clauseFile, (3,3), (3,6), 13, 6, dropletIdList)
    ...
    clauseFile.write("s.add(Or(a_3_11_6_6, a_3_11_5_5))\n")
    clauseFile.write("s.add(Or(a_3_14_5_6, a_3_14_6_6))\n")

    clauseFile.write("s.add(Or(a_3_3_1_13, a_3_3_2_13))\n")
    clauseFile.write("s.add(Or(a_3_6_2_13, a_3_6_2_13))\n")
    ...
    clauseFile.write("s.add(Or(a_3_11_7_21, a_3_11_7_21))\n")
    clauseFile.write("s.add(Or(a_6_11_6_21, a_6_11_6_21))\n")
