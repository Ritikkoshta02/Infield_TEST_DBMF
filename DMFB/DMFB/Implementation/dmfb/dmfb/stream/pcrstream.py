...
def main():
    ...
    clauseFile.write("s.add(a_7_15_5_30)\n")
    clauseFile.write("s.add(a_7_15_3_51)\n")
    clauseFile.write("s.add(a_8_13_4_64)\n")
    clauseFile.write("s.add(a_8_3_2_65)\n")
    clauseFile.write("s.add(a_8_13_11_67)\n")
    clauseFile.write("s.add(a_7_15_8_67)\n")
    clauseFile.write("s.add(a_8_3_10_68)\n")
    clauseFile.write("s.add(a_8_8_6_69)\n")
    clauseFile.write("s.add(a_8_3_7_70)\n")
    clauseFile.write("s.add(a_8_13_1_70)\n")
    clauseFile.write("s.add(a_8_3_13_72)\n")
    clauseFile.write("s.add(a_8_8_12_72)\n")
    clauseFile.write("s.add(a_8_13_9_72)\n")
    
    enforceMixing(clauseFile, (3,11), (3,14), 6, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_11_6_6, a_3_11_5_6))\n")
    clauseFile.write("s.add(Or(a_3_14_6_6, a_3_14_5_6))\n")
    enforceMixing(clauseFile, (3,2), (3,5), 13, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_2_1_13, a_3_2_2_13))\n")
    clauseFile.write("s.add(Or(a_3_5_1_13, a_3_5_2_13))\n")
    enforceMixing(clauseFile, (3,11), (3,14), 16, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_11_7_16, a_3_11_8_16))\n")
    clauseFile.write("s.add(Or(a_3_14_7_16, a_3_14_8_16))\n")
    enforceMixing(clauseFile, (3,5), (3,8), 19, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_5_2_19, a_3_5_4_19))\n")
    clauseFile.write("s.add(Or(a_3_8_2_19, a_3_8_4_19))\n")
    enforceMixing(clauseFile, (3,11), (6,11), 21, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_11_7_21, a_3_11_6_21))\n")
    clauseFile.write("s.add(Or(a_6_11_7_21, a_6_11_6_21))\n")
    enforceMixing(clauseFile, (3,14), (6,14), 23, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_14_5_23, a_3_14_8_23))\n")
    clauseFile.write("s.add(Or(a_6_14_5_23, a_6_14_8_23))\n")

    enforceMixing(clauseFile, (3,5), (6,5), 36, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_5_7_36, a_3_5_2_36))\n")
    clauseFile.write("s.add(Or(a_6_5_7_36, a_6_5_2_36))\n")
    enforceMixing(clauseFile, (3,11), (3,14), 39, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_11_1_39, a_3_11_3_39))\n")
    clauseFile.write("s.add(Or(a_3_14_1_39, a_3_14_3_39))\n")
    enforceMixing(clauseFile, (3,5), (6,5), 44, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_5_13_44, a_3_5_7_44))\n")
    clauseFile.write("s.add(Or(a_6_5_13_44, a_6_5_7_44))\n")
    enforceMixing(clauseFile, (3,11), (6,11), 45, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_11_1_45, a_3_11_8_45))\n")
    clauseFile.write("s.add(Or(a_6_11_1_45, a_6_11_8_45))\n")
    enforceMixing(clauseFile, (3,8), (6,8), 47, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_8_6_47, a_3_8_4_47))\n")
    clauseFile.write("s.add(Or(a_6_8_6_47, a_6_8_4_47))\n")
    enforceMixing(clauseFile, (3,2), (6,2), 57, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_2_2_57, a_3_2_10_57))\n")
    clauseFile.write("s.add(Or(a_6_2_2_57, a_6_2_10_57))\n")
    enforceMixing(clauseFile, (3,13), (6,13), 57, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_13_11_57, a_3_13_4_57))\n")
    clauseFile.write("s.add(Or(a_6_13_11_57, a_6_13_4_57))\n")
    enforceMixing(clauseFile, (3,11), (6,11), 60, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_11_1_60, a_3_11_9_60))\n")
    clauseFile.write("s.add(Or(a_6_11_1_60, a_6_11_9_60))\n")
    enforceMixing(clauseFile, (3,8), (6,8), 62, 6, dropletIdList)
    clauseFile.write("s.add(Or(a_3_8_12_62, a_3_8_6_62))\n")
    clauseFile.write("s.add(Or(a_6_8_12_62, a_6_8_6_62))\n")
    ...
    #insertCheckpoint1X(clauseFile, (5,6), 20, dropletIdList)
    ...
    #insertCheckpoint1X(clauseFile, (5,6), 22, dropletIdList) 
    #insertCheckpoint1X(clauseFile, (8,3), 30, dropletIdList)
    #insertCheckpoint1X(clauseFile, (1,3), 31, dropletIdList)
