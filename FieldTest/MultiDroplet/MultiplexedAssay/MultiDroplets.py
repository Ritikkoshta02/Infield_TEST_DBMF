...
#------------------PCR---------------------------------
ROW = 15         #Dimension of the Biochip
COL = 15
T = 80
init()
...
staticFCforFunctionalDroplets(dropId,'assayMultiplexed15x15.txt', (startRow,startCol),(endRow,endCol))
...
(endRow,endCol) = (15,15)
(sourceRow,sourceCol) = (1,16)
(dispenseRow,dispenseCol) = (1,15)
varDeclare(T,dropId,(startRow,startCol),(endRow,endCol),(sourceRow,sourceCol))
testDropletClause(T,dropId,(sourceRow,sourceCol),(dispenseRow,dispenseCol), (startRow,startCol),(endRow,endCol))
staticFCforFunctionalDroplets(dropId,'assayMultiplexed15x15.txt', (startRow,startCol),(endRow,endCol))
myfile.write('s.add(x_%d_%d_%d_1)\n'%(dropId,sourceRow,sourceCol))
...
staticFCbetweenTestDroplets(T,1,(1,1),(15,8), 2,(1,7),(15,15))
...
edgeCoverage(T,1,(8,6),(8,7))
edgeCoverage(T,1,(8,7),(8,8))
edgeCoverage(T,1,(7,7),(7,8))
edgeCoverage(T,1,(7,7),(8,7))
edgeCoverage(T,1,(7,8),(8,8))
edgeCoverage(T,1,(1,7),(2,7))
edgeCoverage(T,1,(2,7),(3,7))
...
edgeCoverage(T,1,(9,8),(10,8))
edgeCoverage(T,1,(10,8),(11,8))
edgeCoverage(T,1,(11,8),(12,8))
edgeCoverage(T,1,(12,8),(13,8))
edgeCoverage(T,1,(13,1),(13,2))
edgeCoverage(T,1,(13,2),(13,3))
edgeCoverage(T,1,(13,3),(13,4))
edgeCoverage(T,1,(13,4),(13,5))
edgeCoverage(T,1,(13,5),(13,6))
edgeCoverage(T,1,(13,6),(13,7))
edgeCoverage(T,1,(13,7),(13,8))

edgeCoverage(T,2,(1,9),(2,9))
edgeCoverage(T,2,(2,9),(3,9))
edgeCoverage(T,2,(3,9),(4,9))
edgeCoverage(T,2,(4,9),(4,8))
edgeCoverage(T,2,(13,8),(13,9))
edgeCoverage(T,2,(13,9),(13,10))
edgeCoverage(T,2,(13,10),(13,11))
edgeCoverage(T,2,(13,11),(13,12))
edgeCoverage(T,2,(13,12),(13,13))
edgeCoverage(T,2,(13,13),(13,14))
edgeCoverage(T,2,(13,14),(13,15))
edgeCoverage(T,2,(7,9),(8,9))
edgeCoverage(T,2,(7,8),(7,9))
edgeCoverage(T,2,(8,8),(8,9))
edgeCoverage(T,2,(8,9),(8,10))
edgeCoverage(T,2,(8,10),(8,11))
edgeCoverage(T,2,(8,11),(8,12))
edgeCoverage(T,2,(8,12),(8,13))
edgeCoverage(T,2,(3,13),(3,14))
edgeCoverage(T,2,(3,14),(3,15))
edgeCoverage(T,2,(3,13),(4,13))
edgeCoverage(T,2,(4,13),(5,13))
edgeCoverage(T,2,(5,13),(6,13))
edgeCoverage(T,2,(6,13),(7,13))
edgeCoverage(T,2,(7,13),(8,13))
edgeCoverage(T,2,(8,9),(8,10))
edgeCoverage(T,2,(8,10),(8,11))
edgeCoverage(T,2,(8,11),(8,12))
edgeCoverage(T,2,(8,12),(8,13))
